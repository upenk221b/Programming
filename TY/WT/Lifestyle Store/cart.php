...
<html>
    ...
    <body>
        ...
        $id = $_SESSION['id'];
$query = "SELECT * FROM users_items INNER JOIN items ON users_items.item_id = items.id and user_id='$id'";
        ...
        <div class="container" style=" padding-top: 10px; margin-top: 10px" id="w">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="success.php"><btn class="btn btn-primary" style='color: white'>Confirm Order</btn></a></td>
                </tr>
            </table>
        </div>
 <?php } ?>
